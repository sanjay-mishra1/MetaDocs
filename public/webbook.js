!(function (t) {
  ...
  function (t, e, n) {
                          ...
                          r &&
                            ...
                            (function () {
                              var t = P.text,
                                e = _ - u + (j - s) + 2;
                              if ((O || (e -= S + 1), "=" === t[0]))
                                P.text = t.replace(/\w{1,3}\d/g, function (t) {
                                  var n = 0,
                                    r = 0;
                                  return (
                                    o === s ? (n = e - 1) : (r = e - 1),
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if (n) {
                ...
                if ("neq" === n)
                  return J(o !== this.parseValue(r), "notEqual", r);
                if ("lt" === n) return J(o < this.parseValue(r), "lessThan", r);
                if ("lte" === n)
                  return J(o <= this.parseValue(r), "lessThanEqual", r);
                if ("gt" === n)
                  return J(o > this.parseValue(r), "greaterThan", r);
                if ("gte" === n)
                  return J(o >= this.parseValue(r), "greaterThanEqual", r);
              }
              return [!0];
            },
          },
        ...
        (n = [
          ...
          },
          {
            ...
            value: function () {
              ...
              return (
                !r.isClear() &&
                !!ct.call(this, r.range, i.range, n) &&
                (this.changeData(function () {
                  r.isCopy()
                    ? st.call(t, r.range, i.range, e)
                    : r.isCut() && ut.call(t, r.range, i.range);
                }),
                !0)
              );
            },
                    ...
                    if (
                      ...
                      if ("outside" !== n || p) {
                        if ("none" === n)
                          ...
                          for (var d = u; d <= h; d += 1)
                            "top" === n &&
                              (ft.call(this, s, d, { top: [r, i] }),
                              (d += l.getCellMerge(s, d)[1])),
                              "bottom" === n &&
                                (ft.call(this, f, d, { bottom: [r, i] }),
                                (d += l.getCellMerge(f, d)[1]));
                        else if ("left" === n || "right" === n)
                          for (var y = s; y <= f; y += 1)
                            "left" === n &&
                              (ft.call(this, y, u, { left: [r, i] }),
                              (y += l.getCellMerge(y, u)[0])),
                              "right" === n &&
                                (ft.call(this, y, h, { right: [r, i] }),
    ...
    function yt(t) {
      t.xclickoutside &&
        (dt(window.document.body, "click", t.xclickoutside),
    ...
    var kt = (function () {
      function t() {
        ...
        !(function (t, e) {
          ...
          (this.el = a(
            "div",
            "".concat(mt, "-resizer ").concat(n ? "vertical" : "horizontal")
          )
            .children(
              (this.unhideHoverEl = a("div", "".concat(mt, "-resizer-hover"))
                .on("dblclick.stop", function (t) {
                  return e.mousedblclickHandler(t);
                })
                .css("position", "absolute")
                .hide()),
              (this.hoverEl = a("div", "".concat(mt, "-resizer-hover")).on(
                "mousedown.stop",
                function (t) {
                  return e.mousedownHandler(t);
                }
              )),
              (this.lineEl = a("div", "".concat(mt, "-resizer-line")).hide())
            )
            .hide()),
          (this.cRect = null),
    ...
    var St = (function () {
      function t(e) {
        ...
        !(function (t, e) {
          ...
          (this.el = a(
            "div",
            "".concat(mt, "-scrollbar ").concat(e ? "vertical" : "horizontal")
          )
      ...
      Ct = (function () {
        function t() {
          ...
          xt(this, t),
            ...
            (this.cornerEl = a("div", "".concat(mt, "-selector-corner"))),
            (this.areaEl = a("div", "".concat(mt, "-selector-area"))
              .child(this.cornerEl)
              .hide()),
            (this.clipboardEl = a(
              "div",
              "".concat(mt, "-selector-clipboard")
            ).hide()),
            (this.autofillEl = a(
              "div",
              "".concat(mt, "-selector-autofill")
            ).hide()),
            (this.el = a("div", "".concat(mt, "-selector"))
              .css("z-index", "".concat(_t))
    ...
    var Wt = (function () {
      function t(e) {
        ...
        xt(this, t),
          ...
          (this.range = null),
          (this.arange = null),
          (this.el = a("div", "".concat(mt, "-selectors"))
          ...
          },
          {
            ...
            value: function (t, e) {
              ...
              (this.range = r.calSelectedRangeByEnd(t, e)),
                Nt.call(this, this.data.getSelectedRect());
            },
          },
          {
            key: "reset",
              ...
              if (-1 !== t || -1 !== e) {
                ...
                if (null !== this.arange) {
                  ...
                  var p = this.br,
                    ...
                    y = this.t,
                    b = this.tl;
                  p.showAutofill(Tt.call(this, h)),
                    d.showAutofill(At.call(this, h)),
                    y.showAutofill(Pt.call(this, h)),
                    b.showAutofill(h);
                }
              }
            },
    ...
    var Lt = (function () {
      function t(e, n) {
        ...
        !(function (t, e) {
          ...
          (this.filterItems = []),
          (this.items = e),
          (this.el = a("div", "".concat(mt, "-suggest"))
            .css("width", r)
            .hide()),
          (this.itemClick = n),
          (this.itemIndex = -1);
          ...
          },
          {
            ...
            value: function (t) {
              ...
              if (
                ...
                var i = this.el;
                (e = i.html("")).children.apply(e, Vt(r)).show(),
                  vt(i.parent(), function () {
                    n.hide();
                  });
              }
            },
    ...
    var Jt = (function (t) {
      function e(t) {
        ...
        return (
          ...
          ((n = $t(
            this,
            Xt(e).call(this, "div", "".concat(mt, "-icon"))
          )).iconNameEl = a("div", "".concat(mt, "-icon-img ").concat(t))),
            ...
            a("div", "calendar-header").children(
              ...
              a("div", "calendar-header-right").children(
                a("a", "calendar-prev")
                  ...
                  .child(new Jt("chevron-left")),
                a("a", "calendar-next")
                  .on("click.stop", function () {
                    return r.next();
                  })
                  .child(new Jt("chevron-right"))
              )
            ),
    ...
    var re = (function () {
      function t() {
        !(function (t, e) {
          ...
          (this.calendar = new ee(new Date())),
          (this.el = a("div", "".concat(mt, "-datepicker"))
    ...
    var se = (function () {
      function t(e, n, r) {
        ...
        !(function (t, e) {
          ...
          (this.rowHeight = r),
          (this.formulas = e),
          (this.suggest = new Lt(e, function (t) {
            (function (t) {
          ...
          (this.areaEl = a("div", "".concat(mt, "-editor-area"))
            .children(
          ...
          (this.el = a("div", "".concat(mt, "-editor"))
            .child(this.areaEl)
            .hide()),
    ...
    var de = (function (t) {
      function e(t) {
        ...
        return (
          ...
          (n = fe(
            this,
            he(e).call(this, "div", "".concat(mt, "-button ").concat(r))
        ...
        return (
          me(t, [
            ...
            },
            {
              ...
              value: function (t, e, n, r) {
                return (
                  this.ctx.fillRect(Oe(t) - 0.5, Oe(e) - 0.5, Oe(n), Oe(r)),
                  this
                );
              },
            },
              ...
              value: function (t, e) {
                ...
                return (
                  y.forEach(function (t) {
                    var e = o.measureText(t).width;
                    n.fillText(t, h, b),
                      u && Ee.call(n, "strike", h, b, a, l, c.size, e),
                      f && Ee.call(n, "underline", h, b, a, l, c.size, e),
                      (b += c.size + 2);
                  }),
                  o.restore(),
                  this
            ...
            },
            {
              ...
              value: function (t, e) {
                ...
                return (
                  ...
                  (n.strokeStyle = e),
                  "medium" === t
                    ? (n.lineWidth = Oe(2) - 0.5)
                    : "thick" === t
                    ? (n.lineWidth = Oe(3))
                    : "dashed" === t
                    ? n.setLineDash([Oe(3), Oe(2)])
                    : "dotted" === t
                    ? n.setLineDash([Oe(1), Oe(1)])
                    : "double" === t && n.setLineDash([Oe(2), 0]),
                  this
                );
              },
            },
            ...
            },
            {
              ...
              value: function (t) {
                ...
                var n = t.borderTop,
                  ...
                  o = t.borderLeft;
                n &&
                  (this.border.apply(this, ye(n)),
                  this.line.apply(this, ye(t.topxys()))),
                  r &&
                    (this.border.apply(this, ye(r)),
                    this.line.apply(this, ye(t.rightxys()))),
                  i &&
                    (this.border.apply(this, ye(i)),
                    this.line.apply(this, ye(t.bottomxys()))),
                  o &&
                    (this.border.apply(this, ye(o)),
                    this.line.apply(this, ye(t.leftxys()))),
                  e.restore();
              },
            },
            {
              ...
              value: function (t) {
                ...
                e.save(),
                  e.beginPath(),
                  e.moveTo(Oe(i), Oe(o)),
                  e.lineTo(Oe(i + 8), Oe(o)),
                  e.lineTo(Oe(i + 4), Oe(o + 6)),
                  e.closePath(),
            ...
            },
            {
              ...
              value: function (t) {
                ...
                e.save(),
                  e.beginPath(),
                  e.moveTo(Oe(i - 8), Oe(r - 1)),
                  e.lineTo(Oe(i), Oe(r - 1)),
                  e.lineTo(Oe(i), Oe(r + 8)),
                  e.closePath(),
            ...
            },
            {
              ...
              value: function (t, e) {
                ...
                n.save(),
                  n.beginPath(),
                  (n.fillStyle = l || "#fff"),
                  n.rect(Se(r + 1), Se(i + 1), Oe(o - 2), Oe(a - 2)),
                  n.clip(),
                  n.fill(),
                  e(),
                  n.restore();
      ...
      Re = function (t, e, n, r) {
        for (var i = [], o = 0; o < t.length; o += 1) {
          ...
          if ("+" === a) {
            ...
            for (
              var y = Te(a, 2), v = y[0], b = y[1], g = [], m = 0;
              m < b;
              m += 1
            )
              g.push(i.pop());
    ...
    var qe = function (t) {
      ...
      Le = [
        ...
        { key: "text", title: U("format.text"), type: "string", render: qe },
        {
          key: "number",
    ...
    var Xe = 5,
      Ke = { fillStyle: "#f4f5f8" },
      Je = { fillStyle: "#fff", lineWidth: ke, strokeStyle: "#e6e6e6" };
    function Ze(t, e, n) {
      var r =
    ...
    var rn = (function () {
      function t(e, n) {
        !(function (t, e) {
          ...
          (this.el = e),
          (this.draw = new je(e, n.viewWidth(), n.viewHeight())),
          (this.data = n);
      }
      var e, n, r;
      return (
          ...
          },
          {
            ...
            value: function () {
              ...
              var i = t.viewRange(),
                ...
                c = l.x,
                s = l.y;
              nn.call(this, i, n, r, o, a),
                Qe.call(this, i, n, r, -c, -s),
                en.call(this, "all", i, n, r, o, a),
                function (t, e) {
                  var n = this.draw;
                  n.save(),
              ...
              if (f > 0 || h > 0) {
                if (f > 0) {
                  ...
                  (p.sri = 0),
                    (p.eri = f - 1),
                    (p.h = a),
                    nn.call(this, p, n, r, o, 0),
                    Qe.call(this, p, n, r, -c, 0),
                    en.call(this, "top", p, n, r, o, 0);
                }
                if (h > 0) {
                  var d = i.clone();
                  (d.sci = 0),
                    (d.eci = h - 1),
                    (d.w = o),
                    nn.call(this, d, n, r, 0, a),
                    en.call(this, "left", d, n, r, 0, a),
                    Qe.call(this, d, n, r, 0, -s);
                }
                var y = t.freezeViewRange();
                nn.call(this, y, n, r, 0, 0),
                  en.call(this, "all", y, n, r, 0, 0),
                  Qe.call(this, y, n, r, 0, 0),
                  function (t, e, n, r) {
                    var i = this.draw,
                      o = this.data,
                      a = o.viewWidth() - t,
    ...
    var fn = (function () {
      function t(e) {
        ...
        !(function (t, e) {
          ...
          (this.data = e),
          (this.el = a("div", "".concat(mt, "-print"))
            .children(
              a("div", "".concat(mt, "-print-bar")).children(
                a("div", "-title").child("Print settings"),
                a("div", "-right").children(
                  a("div", "".concat(mt, "-buttons")).children(
                    new de("cancel").on("click", un.bind(this, "cancel")),
                    new de("next", "primary").on("click", un.bind(this, "next"))
                  )
                )
              ),
              a("div", "".concat(mt, "-print-content")).children(
              ...
              for (
                var v = { sri: 0, sci: 0, eri: 0, eci: 0 },
                  b = function (n) {
                    var o = 0,
                      l = 0,
                      u = a("div", "".concat(mt, "-canvas-card"))
                        .css("height", "".concat(i, "px"))
                        .css("width", "".concat(r, "px")),
                    ...
                    e.eachMergesInView(v, function (t) {
                      ...
                      (y += l),
                      t.contentEl.child(
                        a("div", "".concat(mt, "-canvas-card-wraper")).child(
                          u.child(b)
                        )
                      );
                  },
      ...
      return dn.map(function (e) {
        return function (t) {
          ...
          return "divider" === t.key
            ? a("div", "".concat(mt, "-item divider"))
            : a("div", "".concat(mt, "-item"))
                .on("click", function () {
    ...
    var vn = (function () {
      function t(e) {
        ...
        !(function (t, e) {
          ...
          (this.menuItems = yn.call(this)),
          (this.el = (n = a("div", "".concat(mt, "-contextmenu"))).children
            .apply(n, hn(this.menuItems))
            .hide()),
          (this.viewFn = e),
        ...
        (n = [
          {
            ...
            value: function () {
              var t = this.tip;
              return a("div", "".concat(mt, "-toolbar-btn"))
    ...
    var En = (function (t) {
      function e() {
        return (
          ...
          kn(this, Sn(e).apply(this, arguments))
        );
      }
      var n, r, i;
      return (
    ...
    var An = (function (t) {
      function e(t, n, r, i) {
        ...
        !(function (t, e) {
          ...
          ((l = Cn(
            this,
            Tn(e).call(this, "div", "".concat(mt, "-dropdown ").concat(i))
          )).title = t),
          (l.change = function () {}),
          (l.headerClick = function () {}),
          "string" == typeof t
            ? (l.title = a("div", "".concat(mt, "-dropdown-title")).child(t))
            : r && l.title.addClass("arrow-left"),
          (l.contentEl = a("div", "".concat(mt, "-dropdown-content"))
            .css("width", n)
            .hide());
        for (
        ...
        return (
          ...
          (l.headerEl = a("div", "".concat(mt, "-dropdown-header"))),
          l.headerEl
            .on("click", function () {
            ...
            .children(
              l.title,
              r
                ? a("div", "".concat(mt, "-icon arrow-right")).child(
                    a("div", "".concat(mt, "-icon-img arrow-down"))
                  )
                : ""
            ),
      ...
      function e(t, n) {
        ...
        var o = new Jt("align-".concat(n)),
          l = t.map(function (t) {
            ...
            a("div", "".concat(mt, "-item")).child(new Jt(e))).on(
              "click",
              function () {
        ...
        return (i = zn(
          ...
          (r = Hn(e)).call.apply(
            r,
            [this, o, "auto", !0, "bottom-left"].concat(In(l))
          )
        ));
      }
      var n, r, i;
    ...
    var Ln = (function (t) {
      function e(t) {
        return (
          ...
          Vn(this, qn(e).call(this, "align", "", t))
        );
      }
      var n, r, i;
      return (
    ...
    var Jn = (function (t) {
      function e(t) {
        return (
          ...
          $n(this, Xn(e).call(this, "valign", "", t))
        );
      }
      var n, r, i;
      return (
    ...
    var rr = (function (t) {
      function e() {
        return (
          ...
          Qn(this, er(e).apply(this, arguments))
        );
      }
      var n, r, i;
      return (
        ...
        (r = [
          {
            ...
            value: function () {
              var t = this,
                n = this.tag;
              return tr(er(e.prototype), "element", this)
                .call(this)
                .child(new Jt(n))
                .on("click", function () {
                  return t.click();
    ...
    var sr = (function (t) {
      function e() {
        return (
          ...
          ar(this, lr(e).call(this, "autofilter"))
        );
      }
      var n, r, i;
      return (
    ...
    var dr = (function (t) {
      function e() {
        return (
          ...
          fr(this, hr(e).call(this, "font-bold", "Ctrl+B"))
        );
      }
      return (
        (function (t, e) {
    ...
    var mr = (function (t) {
      function e() {
        return (
          ...
          vr(this, br(e).call(this, "font-italic", "Ctrl+I"))
        );
      }
      return (
        (function (t, e) {
    ...
    var xr = (function (t) {
      function e() {
        return (
          ...
          kr(this, Or(e).call(this, "strike", "Ctrl+U"))
        );
      }
      return (
        (function (t, e) {
    ...
    var Tr = (function (t) {
      function e() {
        return (
          ...
          jr(this, _r(e).call(this, "underline", "Ctrl+U"))
        );
      }
      return (
        (function (t, e) {
    ...
    function Dr(t) {
      var e = this;
      return a("td", "").child(
        a("div", "".concat(mt, "-color-palette-cell"))
          .on("click.stop", function () {
            return e.change(t);
          })
    ...
    var zr = function t() {
      ...
      !(function (t, e) {
        ...
        (this.el = a("div", "".concat(mt, "-color-palette"))),
        (this.change = function () {});
      var o = a("table", "").children(
        (e = a("tbody", "")).children.apply(
          ...
          [
            (n = a(
              "tr",
              "".concat(mt, "-theme-color-placeholders")
            )).children.apply(
              n,
              Pr(
                Ar.map(function (t) {
            ...
            [
              (r = a("tr", "".concat(mt, "-standard-colors"))).children.apply(
                r,
                Pr(
                  Ir.map(function (t) {
                    return Dr.call(i, t);
    ...
    function Lr(t, e) {
      return !e || ("object" !== qr(e) && "function" != typeof e)
        ? (function (t) {
            if (void 0 === t)
              throw new ReferenceError(
                "this hasn't been initialised - super() hasn't been called"
      ...
      Xr = (function (t) {
        function e(t) {
          ...
          return (r = Lr(
            ...
            (n = Ur(e)).call.apply(
              n,
              [this, i, "auto", !1, "bottom-left"].concat(Br(l))
            )
          ));
        }
        return (
    ...
    function Gr(t) {
      var e = this;
      return a("td", "").child(
        a("div", "".concat(mt, "-border-palette-cell"))
          .child(new Jt("border-".concat(t)))
          .on("click", function () {
            e.mode = t;
            var n = e.mode,
              r = e.style,
    ...
    var Qr = function t() {
      ...
      !(function (t, e) {
        ...
        (this.mode = "all"),
        (this.change = function () {}),
        (this.ddColor = new Vr("line-color", this.color)),
        (this.ddColor.change = function (t) {
          r.color = t;
        }),
        (this.ddType = new Xr(this.style)),
      ...
      var i = Zr(
        a("tr", "").children(
          a("td", "".concat(mt, "-border-palette-left")).child(
            Zr(
          ...
          a("td", "".concat(mt, "-border-palette-right")).children(
            a("div", "".concat(mt, "-toolbar-btn")).child(this.ddColor.el),
            a("div", "".concat(mt, "-toolbar-btn")).child(this.ddType.el)
          )
        )
      );
      this.el.child(i);
    ...
    function ei(t, e) {
      return !e || ("object" !== ti(e) && "function" != typeof e)
        ? (function (t) {
            if (void 0 === t)
              throw new ReferenceError(
                "this hasn't been initialised - super() hasn't been called"
    ...
    var bi = (function (t) {
      function e() {
        return (
          ...
          pi(this, yi(e).apply(this, arguments))
        );
      }
      var n, r, i;
      return (
        ...
        (r = [
          {
            ...
            value: function () {
              var t = this;
              return di(yi(e.prototype), "element", this)
                .call(this)
                .child(new Jt(this.tag))
                .on("click", function () {
    ...
    var Oi = (function (t) {
      function e() {
        return (
          ...
          mi(this, wi(e).call(this, "clearformat"))
        );
      }
      return (
        (function (t, e) {
    ...
    var Ci = (function (t) {
      function e() {
        return (
          ...
          Ei(this, ji(e).call(this, "paintformat"))
        );
      }
      var n, r, i;
      return (
    ...
    var Di = (function (t) {
      function e(t) {
        return (
          ...
          Ai(this, Ri(e).call(this, "color", void 0, t))
        );
      }
      var n, r, i;
      return (
    ...
    var Wi = (function (t) {
      function e(t) {
        return (
          ...
          Mi(this, Ni(e).call(this, "bgcolor", void 0, t))
        );
      }
      var n, r, i;
      return (
    ...
    var Yi = (function (t) {
      function e() {
        ...
        return (n = Bi(
          ...
          (t = Li(e)).call.apply(
            t,
            [this, "10", "60px", !0, "bottom-left"].concat(qi(r))
          )
        ));
      }
      return (
    ...
    var Gi = (function (t) {
      function e() {
        return (
          ...
          Ki(this, Ji(e).call(this, "font-size"))
        );
      }
      var n, r, i;
      return (
    ...
    var io = (function (t) {
      function e() {
        ...
        return (n = eo(
          ...
          (t = no(e)).call.apply(
            t,
            [this, _e[0].title, "160px", !0, "bottom-left"].concat(to(r))
          )
        ));
      }
      return (
    ...
    var uo = (function (t) {
      function e() {
        return (
          ...
          lo(this, co(e).call(this, "font-name"))
        );
      }
      var n, r, i;
      return (
      ...
      function e() {
        ...
        return (
          ...
          (n = yo(
            ...
            (t = vo(e)).call.apply(
              t,
              [this, "Normal", "220px", !0, "bottom-left"].concat(ho(r))
            )
          ))
        );
      }
        ...
        (r = [
          {
            key: "setTitle",
            value: function (t) {
              for (var e = 0; e < Le.length; e += 1)
                Le[e].key === t && this.title.html(Le[e].title());
              this.hide();
            },
          },
        ]) && po(n.prototype, r),
    ...
    var Po = (function (t) {
      function e() {
        ...
        return (n = _o(
          ...
          (t = Co(e)).call.apply(
            t,
            [this, new Jt("formula"), "180px", !0, "bottom-left"].concat(jo(r))
          )
        ));
      }
      return (
    ...
    var Ho = (function (t) {
      function e() {
        return (
          ...
          Io(this, Do(e).call(this, "formula"))
        );
      }
      var n, r, i;
      return (
    ...
    var Go = (function (t) {
      function e() {
        return (
          ...
          Ko(this, Jo(e).call(this, "redo", "Ctrl+Y"))
        );
      }
      return (
        (function (t, e) {
    ...
    var ra = (function (t) {
      function e() {
        return (
          ...
          ta(this, ea(e).call(this, "undo", "Ctrl+Z"))
        );
      }
      return (
        (function (t, e) {
    ...
    var ca = (function (t) {
      function e() {
        return (
          ...
          oa(this, aa(e).call(this, "print", "Ctrl+P"))
        );
      }
      return (
        (function (t, e) {
    ...
    var pa = (function (t) {
      function e() {
        return (
          ...
          ua(this, fa(e).call(this, "textwrap"))
        );
      }
      return (
        (function (t, e) {
    ...
    function ba(t, e) {
      return !e || ("object" !== ya(e) && "function" != typeof e)
        ? (function (t) {
            if (void 0 === t)
              throw new ReferenceError(
                "this hasn't been initialised - super() hasn't been called"
    ...
    var ka = (function (t) {
        function e() {
          ...
          return (
            ((t = ba(
              this,
              ga(e).call(this, n, "auto", !1, "bottom-right", r)
            )).moreBtns = r),
      ...
      Oa = (function (t) {
        function e() {
          var t;
          return (
            va(this, e), (t = ba(this, ga(e).call(this, "more"))).el.hide(), t
          );
        }
        var n, r, i;
        return (
      ...
      function t(e, n) {
        ...
        (this.items = [
          [
            ...
            (this.redoEl = new Go()),
            new ca(),
            (this.paintformatEl = new Ci()),
            (this.clearformatEl = new Oi()),
          ],
          Ea(),
          [(this.formatEl = new xo())],
          Ea(),
          [(this.fontEl = new uo()), (this.fontSizeEl = new Gi())],
          Ea(),
          [
            (this.boldEl = new dr()),
            (this.italicEl = new mr()),
            (this.underlineEl = new Tr()),
            (this.strikeEl = new xr()),
            (this.textColorEl = new Di(o.color)),
          ],
          Ea(),
          [
            (this.fillColorEl = new Wi(o.bgcolor)),
            (this.borderEl = new ui()),
            (this.mergeEl = new $o()),
          ],
          Ea(),
          [
            (this.alignEl = new Ln(o.align)),
            (this.valignEl = new Jn(o.valign)),
            (this.textwrapEl = new pa()),
          ],
          Ea(),
          [
            (this.freezeEl = new Vo()),
            (this.autofilterEl = new sr()),
            (this.formulaEl = new Ho()),
            (this.moreEl = new Oa()),
          ],
        ]),
          (this.el = a("div", "".concat(mt, "-toolbar"))),
          (this.btns = a("div", "".concat(mt, "-toolbar-btns"))),
    ...
    var Pa = (function () {
      function t(e, n) {
        ...
        !(function (t, e) {
          ...
          (this.title = e),
          (this.el = a("div", "".concat(mt, "-modal"))
            .css("width", o)
            .children(
              a("div", "".concat(mt, "-modal-header")).children(
                new Jt("close").on("click.stop", function () {
                  return i.hide();
                }),
                this.title
              ),
              (r = a("div", "".concat(mt, "-modal-content"))).children.apply(
                r,
                Ca(n)
              )
            )
        ...
        (n = [
          {
            ...
            value: function () {
              var t = this;
              (this.dimmer = a("div", "".concat(mt, "-dimmer active"))),
          ...
          },
          {
            ...
            value: function () {
              this.el.hide(),
                ...
                dt(window, "keydown", window.xkeydownEsc),
    ...
    var Ra = (function () {
      function t(e, n) {
        ...
        !(function (t, e) {
          ...
          (this.el = a("div", "".concat(mt, "-form-input"))),
          (this.input = a("input", "")
            .css("width", e)
            .on("input", function (t) {
              return r.vchange(t);
    ...
    var Da = (function () {
      function t(e, n, r) {
        ...
        !(function (t, e) {
          ...
          (this.getTitle = o),
          (this.vchange = function () {}),
          (this.el = a("div", "".concat(mt, "-form-select"))),
          (this.suggest = new Lt(
            n.map(function (t) {
      ...
      Ma = (function () {
        function t(e, n, r, i) {
          ...
          !(function (t, e) {
            ...
            (this.el = a("div", "".concat(mt, "-form-field")).children(
              this.label,
              e.el,
              this.tip
            ));
          ...
          (n = [
            ...
            },
            {
              ...
              value: function () {
                ...
                if ((e.type || e.pattern) && !(e.pattern || Ha[e.type]).test(i))
                  return (
    ...
    var Ba = 100,
      La = (function (t) {
        function e() {
          ...
          var n = new Ma(
              new Da("cell", ["cell"], "100%", function (t) {
            ...
            l = new Ma(new Ra("70px", "10"), { required: !0 }).hide(),
            c = new Ma(new Ra("70px", "100"), {
              required: !0,
              type: "number",
            }).hide(),
            s = new Ma(new Ra("120px", "a,b,c"), { required: !0 }),
          ...
          return (
            ((t = Wa(
              this,
              Va(e).call(this, L("contextmenu.validation"), [
                a("div", "".concat(mt, "-form-fields")).children(n.el, r.el),
                a("div", "".concat(mt, "-form-fields")).children(
                  i.el,
                  o.el,
                  l.el,
                  c.el,
                ...
                a("div", "".concat(mt, "-buttons")).children(
                  new de("cancel").on("click", function () {
    ...
    var Ka = (function () {
      function t() {
        ...
        !(function (t, e) {
          ...
          (this.filterbEl = a("div", "".concat(mt, "-body"))),
          (this.filterhEl = a("div", "".concat(mt, "-header state")).on(
            "click.stop",
            function () {
              return e.filterClick(0, "all");
            }
          )),
          (this.el = a("div", "".concat(mt, "-sort-filter"))
            .children(
              (this.sortAscEl = $a.call(this, "asc")),
              (this.sortDescEl = $a.call(this, "desc")),
              Ya("divider"),
              a("div", "".concat(mt, "-filter")).children(
                this.filterhEl,
                this.filterbEl
              ),
              a("div", "".concat(mt, "-buttons")).children(
                ...
                function (t) {
                  ...
                  n.html(""),
                    Object.keys(t).forEach(function (i, o) {
                      ...
                      n.child(
                        a("div", "".concat(mt, "-item state ").concat(c))
                          .on("click.stop", function () {
    ...
    function Ja(t, e) {
      ...
      n.children(
        a("div", "".concat(mt, "-toast-header")).children(
          new Jt("close").on("click.stop", function () {
            return (
        ...
        a("div", "".concat(mt, "-toast-content")).html(e)
      ),
    ...
    function ul(t) {
      ...
      t.shiftKey ||
        (c ? n.showAutofill(d, y) : tl.call(this, !1, d, y),
        bt(
          window,
          function (t) {
            ...
            (d = i.ri),
              ...
              c
                ? n.showAutofill(d, y)
                : 1 !== t.buttons || t.shiftKey || tl.call(e, !0, d, y, !0, !0);
          },
          function () {
            c &&
              n.arange &&
    ...
    function pl(t) {
      var e =
        ...
        r = this.table;
      if (
        "read" !== n.settings.mode &&
        (n.setSelectedCellText(t, e), "finished" === e)
      ) {
        var i = n.selector,
          o = i.ri,
          a = i.ci;
    ...
    function yl(t, e) {
      ...
      if ("undo" === t) this.undo();
        ...
        n.setSelectedCellAttr(t, e),
          "formula" !== t || n.selector.multiple() || hl.call(this),
          il.call(this);
    }
    function vl() {
      var t,
      ...
      c
        .on("mousemove", function (t) {
          (function (t) {
            if (
              0 === t.buttons &&
              t.target.className !== "".concat(mt, "-resizer-hover")
            ) {
              var e = t.offsetX,
                n = t.offsetY,
                r = this.rowResizer,
          ...
          p.clear(),
            ...
            2 === t.buttons
              ? (a.data.xyInSelectedRect(t.offsetX, t.offsetY)
                  ...
                  : (ul.call(a, t), d.setPosition(t.offsetX, t.offsetY)),
                t.stopPropagation())
              : 2 === t.detail
              ? hl.call(a)
              : ul.call(a, t);
        ...
        .on("mousewheel.stop", function (t) {
          (function (t) {
            var e = this.verticalScrollbar,
              ...
              p = Math.abs(s),
              d = Math.max(h, p);
            /Firefox/i.test(window.navigator.userAgent) && Qa(f(t.detail), 50),
              d === p &&
                Qa(
                  (function (t) {
                    if (t > 0) {
            ...
            if (r || o)
              switch (e) {
                ...
                case 40:
                  ...
                  break;
                case 32:
                  tl.call(a, !1, -1, a.data.selector.ci, !1),
                    t.preventDefault();
                  break;
                case 66:
                  y.trigger("bold");
              ...
              switch (e) {
                ...
                case 9:
                  p.clear(),
                    el.call(a, !1, i ? "left" : "right"),
                    t.preventDefault();
                  break;
                case 13:
                  p.clear(),
                    el.call(a, !1, i ? "up" : "down"),
                    t.preventDefault();
                  break;
                case 8:
              ...
              "Delete" === n
                ...
                : (e >= 65 && e <= 90) ||
                  ...
                  (e >= 96 && e <= 105) ||
                  "=" === t.key
                ? (pl.call(a, t.key, "input"), hl.call(a))
                : 113 === e && hl.call(a);
            }
          }
        });
    ...
    var bl = (function () {
      function t(e, n) {
        ...
        var i = n.settings,
          ...
          l = i.showToolbar,
          c = i.showContextmenu;
        (this.el = a("div", "".concat(mt, "-sheet"))),
          (this.toolbar = new _a(n, o.width, !l)),
          (this.print = new fn(n)),
          e.children(this.toolbar.el, this.el, this.print.el),
          (this.data = n),
          (this.tableEl = a("canvas", "".concat(mt, "-table"))),
          (this.rowResizer = new kt(!1, n.rows.height)),
          (this.colResizer = new kt(!0, n.cols.minWidth)),
          (this.verticalScrollbar = new St(!0)),
          (this.horizontalScrollbar = new St(!1)),
          (this.editor = new se(
            Me,
            function () {
          ...
          (this.modalValidation = new La()),
          (this.contextMenu = new vn(function () {
            return r.getRect();
          }, !c)),
          (this.selector = new Wt(n)),
          (this.overlayerCEl = a(
            "div",
            "".concat(mt, "-overlayer-content")
          ).children(this.editor.el, this.selector.el)),
          (this.overlayerEl = a("div", "".concat(mt, "-overlayer")).child(
            this.overlayerCEl
          )),
          (this.sortFilter = new Ka()),
          this.el.children(
            this.tableEl,
            this.overlayerEl.el,
            this.rowResizer.el,
          ...
          (this.table = new rn(this.tableEl.el, n)),
          vl.call(this),
          il.call(this),
          tl.call(this, !1, 0, 0);
      }
    ...
    var _l = (function (t) {
        function e(t) {
          ...
          return (
            ((n = xl(
              this,
              El(e).call(this, r, "auto", !1, "top-left")
            )).contentClick = t),
            n
          );
        }
      ...
      Cl = [{ key: "delete", title: U("contextmenu.deleteSheet") }];
    function Tl() {
      var t = this;
    ...
    var Pl = (function () {
        function t() {
          var e;
          kl(this, t),
            (this.el = (e = a("div", "".concat(mt, "-contextmenu")).css(
              "width",
              "160px"
            )).children
              .apply(e, wl(Tl.call(this)))
              .hide()),
            (this.itemClick = function () {});
        }
        return (
      ...
      Al = (function () {
        function t() {
          ...
          kl(this, t),
            ...
            (this.deleteEl = null),
            (this.items = []),
            (this.moreEl = new _l(function (t) {
              e.clickSwap2(e.items[t]);
            })),
            (this.contextMenu = new Pl()),
            (this.contextMenu.itemClick = i),
            (this.el = a("div", "".concat(mt, "-bottombar")).children(
              this.contextMenu.el,
              (this.menuEl = a("ul", "".concat(mt, "-menu")).child(
                a("li", "").children(
                  new Jt("add").on("click", function () {
                    e.dataNames.length < 10
                      ? n()
                      : Ja("tip", "it less than or equal to 10");
                  }),
